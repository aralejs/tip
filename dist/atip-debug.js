define("arale/tip/1.1.1/atip-debug", [ "$-debug", "./tip-debug", "arale/popup/1.0.2/popup-debug", "arale/overlay/1.0.1/overlay-debug", "arale/position/1.0.0/position-debug", "arale/iframe-shim/1.0.1/iframe-shim-debug", "arale/widget/1.0.3/widget-debug", "arale/base/1.0.1/base-debug", "arale/class/1.0.0/class-debug", "arale/events/1.0.0/events-debug", "./atip-debug.handlebars" ], function(require, exports, module) {
    var $ = require("$-debug");
    ...
    var Atip = Tip.extend({
        attrs: {
            template: require("./atip-debug.handlebars"),
            // 提示内容
            content: "这是一个提示框",
            // 箭头位置
...
define("arale/tip/1.1.1/atip-debug.handlebars", [ "gallery/handlebars/1.0.0/runtime-debug" ], function(require, exports, module) {
    var Handlebars = require("gallery/handlebars/1.0.0/runtime-debug");
